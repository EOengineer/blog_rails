...
<br>
<span class="code-heading">To use the generator, run the following command:</span>
<code>Rails new Blog --database=postgresql</code><br>
...
<span class="code-heading">Now to start the rails server, run:</span>
<code>rails s</code>
